  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="flex gap-4">
        <button onClick={handleGenerate} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded">
          Generate Statement
        </button>
        <button onClick={handleExportPDF} className="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded">
          Export PDF
        </button>
      </div>
